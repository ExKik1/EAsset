...
interface ProdiPaginationProps {
  perPage: number;
...
export default function ProdiPagination({
  perPage,
  setPerPage,
  currentPage,
  setCurrentPage,
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto text-center sm:text-left justify-center">
        <div className="flex items-center gap-2 bg-white px-2.5 py-1.5 rounded-lg border border-[#cecece] shadow-sm">
          ...
          <select
            ...
            className="bg-transparent focus:outline-hidden font-bold text-slate-700 cursor-pointer text-xs"
          >
