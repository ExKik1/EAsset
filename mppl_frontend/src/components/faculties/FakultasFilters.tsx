...
interface FakultasFiltersProps {
  searchQuery: string;
  setSearchQuery: (query: string) => void;
}

export default function FakultasFilters({
  searchQuery,
  setSearchQuery,
}: FakultasFiltersProps) {
  return (
    <div className="grid grid-cols-1 gap-3 bg-white p-3 sm:p-4 border border-info-border shadow-sm">
      <div className="relative w-full">
        ...
        <input
          type="text"
          placeholder="Cari berdasarkan kode fakultas, nama fakultas, deskripsi..."
          value={searchQuery}
