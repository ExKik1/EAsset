...
interface HistoryLogPaginationProps {
  perPage: number;
...
export default function HistoryLogPagination({
  perPage,
  setPerPage,
  currentPage,
  setCurrentPage,
    ...
    <div className="bg-slate-50 px-4 py-4 border-t border-info-border flex flex-col sm:flex-row gap-4 items-center justify-between text-xs font-medium text-slate-500">
      ...
      <div className="flex items-center gap-1.5 justify-center w-full sm:w-auto">
        <button
          ...
          className="p-2 bg-white border border-[#cecece] rounded-lg hover:bg-slate-100 disabled:opacity-40 disabled:hover:bg-white disabled:cursor-not-allowed text-slate-600 transition shadow-sm"
        >
